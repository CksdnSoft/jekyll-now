...
Hashing can be made so that it is easily decryptable, but with enough effort, it can be made so that it is impossible
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Mzg2MTAwMjgsLTE3MjgxMDgxNjIsND
